 ...
 */
public class XmlPageTest extends GeoServerWicketTestSupport {
    ...
    public void testStructure() {
        ...
        tester.startPage(new XmlPage(null, null, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"));
        tester.assertRenderedPage(XmlPage.class);
