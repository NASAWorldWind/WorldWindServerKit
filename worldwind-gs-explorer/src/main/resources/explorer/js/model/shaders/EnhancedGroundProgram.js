 ...
 */
/**
 * @exports EnhancedGroundProgram
 */
define(['model/shaders/EnhancedAtmosphereProgram'],
    function (EnhancedAtmosphereProgram) {
        "use strict";

        /**
         * Constructs a new GroundProgram program.
         ...
         *
         * @alias EnhancedGroundProgram
         * @constructor
         * @augments EnhancedAtmosphereProgram
         * @classdesc EnhancedGroundProgram is a GLSL program that draws the ground component of the atmosphere.
         * @param {WebGLRenderingContext} gl The current WebGL context.
         * @throws {ArgumentError} If the shaders cannot be compiled, or linking of
         * the compiled shaders into a program fails.
         */
        var EnhancedGroundProgram = function (gl) {
            ...
            EnhancedAtmosphereProgram.call(this, gl, vertexShaderSource, fragmentShaderSource, ["vertexPoint", "vertexTexCoord"]);
        };
         ...
         * @readonly
         */
        EnhancedGroundProgram.key = "EnhancedGpuGroundProgram";

        // Inherit from AtmosphereProgram.
        EnhancedGroundProgram.prototype = Object.create(EnhancedAtmosphereProgram.prototype);

        return EnhancedGroundProgram;
    });
